                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="../cap-nhat-thong-tin/cap-nhat-thong-tin-khach-hang.php?id=<?= $row['id'] ?>&ho_ten=<?= $row['ho_ten'] ?>&gioi_tinh=<?= $row['gioi_tinh'] ?>&dia_chi=<?= $row['dia_chi']?>&email=<?= $row['email'] ?>" class="btn btn-edit">
                                            <i class="fa-solid fa-edit"></i> Sửa
                                        </a>
                                        <a href="?action=xoa&id=<?= $row['id']?>" onclick="return confirm('Bạn có chắc chắn muốn xóa khách hàng này không?')" class="btn btn-delete">
